                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{asset('admin/admin_add')}}">管理员添加</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="dataTables_length" id="example1_length">
                                            <label>显示
                                                <select id="number" name="example1_length" aria-controls="example1"
                                        ...
                                        <div id="example1_filter" class="dataTables_filter">
                                            <label>名称搜索:
                                                <input id="search" type="search" class="form-control form-control-sm"
                                                       placeholder="" aria-controls="example1" value="{{$search}}"><button id="search_button" >搜索</button>
                                            </label>
                                        </div>
                                    </div>
                                </div>
